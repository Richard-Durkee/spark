...
object FunctionRegistry {
  ...
  val expressions: Map[String, (ExpressionInfo, FunctionBuilder)] = Map(
    ...
    expressionBuilder("zip_explode", ZipExplodeExpressionBuilder),
    expressionGeneratorBuilderOuter("zip_explode_outer", ZipExplodeExpressionBuilder),
...
object TableFunctionRegistry {
  ...
  val logicalPlans: Map[String, (ExpressionInfo, TableFunctionBuilder)] = Map(
    ...
    generatorBuilder("zip_explode", ZipExplodeGeneratorBuilder),
    generatorBuilder("zip_explode_outer", ZipExplodeOuterGeneratorBuilder),
